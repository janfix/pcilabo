...
define(['qtiCustomInteractionContext', 'IMSGlobal/jquery_2_1_1', 'fake/runtime/js/renderer', 'OAT/util/event'], function(qtiCustomInteractionContext, $, renderer, event){
    'use strict';
    ...
    qtiCustomInteractionContext.register(fake);
});
