...
define([
    ...
    'tpl!fake/creator/tpl/propertiesForm',
    'lodash',
    'jquery'
], function(stateFactory, Question, formElement, simpleEditor, containerEditor, formTpl, _, $){
    'use strict';

    var fakeStateQuestion = stateFactory.extend(Question, function(){
     ...
     fakeStateQuestion.prototype.initForm = function(){
